...
public class OrderWebMapperImpl implements OrderWebMapper {
    ...
    @Override
    public PageResponseDTO<OrderDTO> mapToPageResponseDto(PageResponse<Order> pageResponse) {
        if ( pageResponse == null ) {
            return null;
        }

        PageResponseDTO<OrderDTO> pageResponseDTO = new PageResponseDTO<OrderDTO>();
        ...
        pageResponseDTO.setContent( orderSetToOrderDTOSet( pageResponse.getContent() ) );
